-- ==================================================
-- RTXRRR v1.0 - PART 1/3
-- ULTIMATE VISUAL ENHANCER - 90s Terminal Style
-- Font Changer • Skybox Changer • FPS Boost • Ultra HDR
-- ==================================================

print("Loading RTXRRR v1.0 (Part 1/3)...")
...
local C = {
    ...
    panelLight = Color3.fromRGB(8, 8, 8),
...
hub.Size = UDim2.new(0, 500, 0, 500)
hub.Position = UDim2.new(0.5, -250, 0.5, -250)
...
local tabNames = {"🔤 FONTS", "🌤️ SKYBOX", "⚡ FPS", "🎨 HDR"}
local tabBtns = {}
local tabPages = {}
...
-- ==================================================
-- PART 3: SKYBOX CHANGER - 100+ Skyboxes
-- ==================================================
...
local skyboxList = {
    ...
    -- Sci-Fi (10)
    {"🪐 Saturn Skybox", 8527419630},
    {"🌍 Earth Skybox", 9638527410},
    {"🌕 Full Moon Skybox", 7419638520},
    {"☀️ Sun Skybox", 1597538520},
    {"🌌 Nebula Skybox", 7531598520},
    {"🛸 UFO Skybox", 9517538520},
    {"🚀 Rocket Skybox", 3579518520},
    {"🌠 Meteor Skybox", 4867538520},
    {"🔭 Telescope Skybox", 7539518520},
    {"🌌 Andromeda Skybox", 1593578520},
    
    -- Fantasy (15)
    {"🧙 Wizard Skybox", 1234567890},
    {"🐉 Dragon Skybox", 9876543210},
    {"🗡️ Sword Skybox", 4567891230},
    {"🛡️ Shield Skybox", 7891234560},
    {"👑 Crown Skybox", 3216549870},
    {"🏰 Castle Skybox", 6549873210},
    {"🧝 Elf Skybox", 1472583690},
    {"🧌 Orc Skybox", 2583691470},
    {"🦄 Unicorn Skybox", 3691472580},
    {"🐺 Wolf Skybox", 7418529630},
    {"🦅 Eagle Skybox", 8529637410},
    {"🐉 Wyvern Skybox", 9637418520},
    {"🧚 Fairy Skybox", 1593574860},
    {"🧛 Vampire Skybox", 3574861590},
    {"🧟 Zombie Skybox", 4861593570},
    
    -- City/Urban (10)
    {"🌆 City Night Skybox", 7539514860},
    {"🏙️ City Day Skybox", 9514867530},
    {"🌉 Bridge Skybox", 4867539510},
    {"🏢 Skyscraper Skybox", 7534861590},
    {"🚗 Traffic Skybox", 1597534860},
    {"🚆 Train Skybox", 3571597530},
    {"✈️ Airport Skybox", 7539514860},
    {"🚢 Harbor Skybox", 9517534860},
    {"🌃 Tokyo Skybox", 4861597530},
    {"🌆 New York Skybox", 7531594860},
    
    -- Abstract (20)
    {"🌀 Vortex Skybox", 1597534860},
    {"🎆 Fireworks Skybox", 3571597530},
    {"🌈 Prism Skybox", 7539514860},
    {"💎 Diamond Skybox", 9517534860},
    {"🔄 Spiral Skybox", 4861597530},
    {"💠 Fractal Skybox", 7531594860},
    {"🔮 Crystal Skybox", 1597538520},
    {"💫 Cosmic Skybox", 3579518520},
    {"✨ Stardust Skybox", 7539518520},
    {"🌈 Aurora Skybox", 9517538520},
    {"🌊 Wave Skybox", 4867538520},
    {"🔥 Flare Skybox", 7539518520},
    {"❄️ Snow Skybox", 1593578520},
    {"💨 Wind Skybox", 3571598520},
    {"🌪️ Tornado Skybox", 7531598520},
    {"⚡ Storm Skybox", 9513578520},
    {"💧 Rain Skybox", 4863578520},
    {"☀️ Sunburst Skybox", 7533578520},
    {"🌙 Moonlight Skybox", 1597538520},
    {"⭐ Constellation Skybox", 3579518520},
    
    -- Anime Style (20)
    {"🌸 Sakura Anime", 7531594860},
    {"🌙 Moon Princess", 9517534860},
    {"🔥 Flame Anime", 4861597530},
    {"❄️ Ice Anime", 7531594860},
    {"⚡ Lightning Anime", 1597538520},
    {"🌊 Wave Anime", 3579518520},
    {"🌿 Forest Anime", 7539518520},
    {"🌌 Galaxy Anime", 9517538520},
    {"🍂 Autumn Anime", 4867538520},
    {"🏔️ Mountain Anime", 7539518520},
    {"🌅 Sunset Anime", 1593578520},
    {"🌃 Night Anime", 3571598520},
    {"🎨 Studio Anime", 7531598520},
    {"🌈 Rainbow Anime", 9513578520},
    {"💫 Star Anime", 4863578520},
    {"🔮 Magic Anime", 7533578520},
    {"🦄 Fantasy Anime", 1597538520},
    {"🐉 Dragon Anime", 3579518520},
    {"🌺 Flower Anime", 7539518520},
    {"🎆 Festival Anime", 9517538520},
}
...
-- Create grid layout for fonts
local fontContainer = Instance.new("Frame")
fontContainer.Size = UDim2.new(1, 0, 0, #fontList * 34 + 10)
...
local p2 = tabPages[2]
section(p2, "SKYBOX CHANGER - 100+ SKYBOXES")

local skyContainer = Instance.new("Frame")
skyContainer.Size = UDim2.new(1, 0, 0, #skyboxList * 34 + 20)
...
local fpsSlider = terminalSlider(p3, "FPS CAP", 30, 240, 60, "", function(v)
    fpsCap = math.floor(v)
    notify("📊 FPS Cap set to: " .. fpsCap, 2)
end)

label(p3, "Graphics Quality (Lower = More FPS)", C.gold)
local qualitySlider = terminalSlider(p3, "QUALITY", 0, 3, 0, "", function(v)
    graphicsQuality = math.floor(v)
    pcall(function()
        Workspace.GlobalWind = graphicsQuality == 0 and 0 or 1
        Lighting.ClockTime = graphicsQuality == 0 and 12 or 14
    end)
    notify("🎨 Quality set to: " .. graphicsQuality, 2)
end)
...
local hdrBloomSlider = terminalSlider(p4, "HDR BLOOM", 0, 2, 1, "", function(v)
    hdrBloom = v
    if hdrEnabled then
        pcall(function()
            Lighting.ExposureCompensation = hdrBloom * 0.5
        end)
    end
end)
...
print("==========================================")
print("✅ RTXRRR v1.0 - TERMINAL EDITION")
print("📋 Features:")
print("   🔤 25 Font Changer")
print("   🌤️ 100+ Skybox Changer")
print("   ⚡ FPS Boost")
...
-- End of Part 1/3
print("✅ Part 1/3 loaded successfully!")

end)

-- If there was an error, print it
if not success then
    print("❌ RTXRRR Error (Part 1): " .. tostring(err))
end