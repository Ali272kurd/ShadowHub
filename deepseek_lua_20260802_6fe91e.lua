...
-- ==================================================
-- MOBILE TOGGLE BUTTON - BIGGER FOR TOUCH
-- ==================================================
...
-- ==================================================
-- MAIN HUB - BIGGER FOR MOBILE
-- ==================================================

local hub = Instance.new("Frame")
hub.Size = isMobile and UDim2.new(0, 520, 0, 580) or UDim2.new(0, 450, 0, 500)
hub.Position = UDim2.new(0.5, -(isMobile and 260 or 225), 0.5, -(isMobile and 290 or 250))
...
-- ==================================================
-- TOGGLE BUTTON CLICK - MOBILE FRIENDLY
-- ==================================================
...
content.Size = UDim2.new(1, -20, 1, -(isMobile and 110 or 92))
...
local function section(parent, text)
    ...
    s.Size = UDim2.new(1, 0, 0, isMobile and 26 or 22)
...
ftText.Text = "$ RTXRRR v6.0 // MOBILE EDITION"
...
-- ==================================================
-- MOBILE KEYBIND (None on mobile, just use button)
-- ==================================================

-- PC Keybind (Right Control) - only works on PC
...
print("==========================================")
print("✅ RTXRRR v6.0 - MOBILE EDITION")
print("📋 Features:")
