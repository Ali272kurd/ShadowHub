...
-- Fixed Floating Buttons • Skybox Changer • Font Changer
...
activateBtn.MouseButton1Click:Connect(function()
    ...
    if key == "Ali" then
        ...
        notify("🔷 ReddieHub v25.1 Loaded! Click 🔷 to open", 4)
...
local function createFloatingButtons()
    ...
    fwdBtn.Size = UDim2.new(0, 55, 0, 55)
    fwdBtn.Position = UDim2.new(0.5, -27.5, 0.35, 0)
    ...
    bwdBtn.Size = UDim2.new(0, 55, 0, 55)
    bwdBtn.Position = UDim2.new(0.5, -27.5, 0.45, 0)
    ...
    lftBtn.Size = UDim2.new(0, 55, 0, 55)
    lftBtn.Position = UDim2.new(0.45, -27.5, 0.4, 0)
    ...
    rgtBtn.Size = UDim2.new(0, 55, 0, 55)
    rgtBtn.Position = UDim2.new(0.55, -27.5, 0.4, 0)
    ...
    upBtn.Position = UDim2.new(0.5, -27.5, 0.3, 0)
    ...
    downBtn.Position = UDim2.new(0.5, -27.5, 0.5, 0)
    ...
    -- Button click functions - FIXED with proper teleport
...
-- ==================================================
-- SKYBOX CHANGER - FIXED with more skyboxes
-- ==================================================
...
-- ==================================================
-- FONT CHANGER - FIXED for every game
-- ==================================================

local function changeFont(fontName)
    pcall(function()
        -- Change font for ALL GUI elements in the game
        ...
        -- Scan ALL GUI elements in the entire game
        local function scanAllGuis()
            ...
            -- Any other GUI elements in workspace
        ...
        -- Keep applying every few seconds for new GUI elements
        task.spawn(function()
            while true do
                task.wait(2)
                scanAllGuis()
...
-- ==================================================
-- TAB 6: SKYBOX CHANGER - FIXED with more skyboxes
-- ==================================================

local p6 = tabPages[6]
section(p6, "SKYBOX CHANGER")

-- Create scrollable container for skyboxes
...
-- ==================================================
-- TAB 8: STATS (Fixed - was p6_stats but we added tabs)
-- ==================================================

-- Stats is now at index 8 (we have 7 tabs total, stats is the last one)
local p8 = tabPages[6] -- Stats is the 6th tab page (since we have 7 tabs, stats is at index 6)
...
ftText.Text = "🔷 ReddieHub v25.1 • Made by aliiiwyddd"
