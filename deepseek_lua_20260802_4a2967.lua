...
hub.Size = isMobile and UDim2.new(0, 480, 0, 560) or UDim2.new(0, 420, 0, 480)
hub.Position = UDim2.new(0.5, -(isMobile and 240 or 210), 0.5, -(isMobile and 280 or 240))
...
title.Size = UDim2.new(1, -20, 0, isMobile and 28 or 22)
title.Position = UDim2.new(0, 10, 0, isMobile and 4 or 3)
title.BackgroundTransparency = 1
title.Text = "$ RTXRRR v6.2 // MOBILE"
...
subTitle.Size = UDim2.new(1, -20, 0, isMobile and 14 or 11)
subTitle.Position = UDim2.new(0, 10, 0, isMobile and 34 or 27)
...
closeB.Size = UDim2.new(0, isMobile and 32 or 26, 0, isMobile and 32 or 26)
closeB.Position = UDim2.new(1, -(isMobile and 40 or 34), 0.5, -(isMobile and 16 or 13))
closeB.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
closeB.BackgroundTransparency = 0.3
closeB.Text = "X"
closeB.TextColor3 = C.primary
closeB.TextSize = isMobile and 14 or 12
...
tabContainer.Size = UDim2.new(1, -20, 0, isMobile and 32 or 26)
tabContainer.Position = UDim2.new(0, 10, 0, isMobile and 56 or 44)
tabContainer.BackgroundTransparency = 1
tabContainer.BorderSizePixel = 0
tabContainer.Parent = hub

local content = Instance.new("Frame")
content.Size = UDim2.new(1, -20, 1, -(isMobile and 105 or 85))
content.Position = UDim2.new(0, 10, 0, isMobile and 92 or 74)
...
for i, name in ipairs(tabNames) do
    ...
    btn.Size = UDim2.new(0, isMobile and 84 or 76, 0, isMobile and 28 or 22)
    btn.Position = UDim2.new(0, (i-1) * (isMobile and 88 or 80), 0, 0)
...
local function section(parent, text)
    ...
    s.Size = UDim2.new(1, 0, 0, isMobile and 24 or 20)
...
local function label(parent, text, color)
    local l = Instance.new("TextLabel")
    l.Size = UDim2.new(1, 0, 0, isMobile and 18 or 14)
    l.BackgroundTransparency = 1
    l.Text = text
...
local function terminalButton(parent, text, cb, color)
    ...
    b.Size = UDim2.new(1, 0, 0, isMobile and 30 or 24)
    b.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
...
local function terminalToggle(parent, text, default, cb)
    ...
    f.Size = UDim2.new(1, 0, 0, isMobile and 30 or 24)
    ...
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0, isMobile and 40 or 34, 0, isMobile and 22 or 18)
    btn.Position = UDim2.new(1, -(isMobile and 48 or 40), 0.5, -(isMobile and 11 or 9))
    ...
    btn.TextSize = isMobile and 9 or 7
    btn.Font = Enum.Font.Code
    btn.Parent = f
...
local function terminalSlider(parent, text, min, max, def, suffix, cb)
    suffix = suffix or ""
    local f = Instance.new("Frame")
    f.Size = UDim2.new(1, 0, 0, isMobile and 38 or 32)
    f.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    f.BackgroundTransparency = 0.1
    f.BorderSizePixel = 1
    f.BorderColor3 = C.dim
    ...
    local l = Instance.new("TextLabel")
    l.Size = UDim2.new(1, -16, 0, isMobile and 16 or 14)
    l.Position = UDim2.new(0, 6, 0, 2)
    l.BackgroundTransparency = 1
    l.Text = text .. ": " .. tostring(def) .. suffix
    l.TextColor3 = C.text
    l.TextSize = isMobile and 10 or 8
    l.Font = Enum.Font.Code
    l.TextXAlignment = Enum.TextXAlignment.Left
    l.Parent = f
    ...
    bg.Position = UDim2.new(0, 8, 0, isMobile and 24 or 20)
    ...
    valueInput.Size = UDim2.new(0, isMobile and 40 or 34, 0, isMobile and 18 or 14)
    valueInput.Position = UDim2.new(1, -(isMobile and 48 or 40), 0, 0)
    valueInput.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    valueInput.Text = tostring(def)
    valueInput.TextColor3 = C.text
    valueInput.TextSize = isMobile and 10 or 8
...
local function terminalColorPicker(parent, text, default, cb)
    ...
    colorBtn.Size = UDim2.new(0, isMobile and 30 or 26, 0, isMobile and 22 or 18)
    colorBtn.Position = UDim2.new(0, 78, 0.5, -(isMobile and 11 or 9))
    ...
    colorBtn.MouseButton1Click:Connect(function()
        ...
        menu.Size = UDim2.new(0, 130, 0, 30)
        menu.Position = UDim2.new(0, 78, 0, 28)
...
crosshairInput.Size = UDim2.new(1, -10, 0, isMobile and 30 or 24)
...
crosshairInput.TextSize = isMobile and 10 or 9
...
footer.Size = UDim2.new(1, -8, 0, isMobile and 20 or 18)
footer.Position = UDim2.new(0, 4, 1, -(isMobile and 24 or 20))
...
ftText.Text = "$ RTXRRR v6.2 // MOBILE EDITION"
ftText.TextColor3 = C.dim
ftText.TextSize = isMobile and 10 or 8
...
print("==========================================")
print("✅ RTXRRR v6.2 - MOBILE EDITION (FULLY FIXED)")
print("📋 Features:")
