-- ==================================================
-- RTXRRR v2.0 - ULTIMATE VISUAL ENHANCER (FIXED)
-- 90s Terminal Style • Font Changer • Skybox Changer • FPS Boost • Ultra HDR
-- ==================================================

print("Loading RTXRRR v2.0...")
...
local C = {
    ...
    secondary = Color3.fromRGB(100, 100, 100),     -- Dark Gray
...
title.Text = "$ RTXRRR v2.0 // VISUAL ENHANCER"
...
ftText.Text = "$ RTXRRR v2.0 // TERMINAL EDITION"
...
print("==========================================")
print("✅ RTXRRR v2.0 - TERMINAL EDITION (FIXED)")
print("📋 Features:")
