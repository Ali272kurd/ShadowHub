-- ==================================================
-- RTXRRR v8.0 - FINAL WORKING VERSION
-- Terminal Style • 90s Aesthetic • Mobile/PC Optimized
-- Font Changer • Skybox Changer • FPS Boost • Ultra HDR • ESP • Crosshair
-- ==================================================

print("Loading RTXRRR v8.0...")
...
title.Text = "$ RTXRRR v8.0 // VISUAL ENHANCER"
...
for i, name in ipairs(tabNames) do
    ...
    btn.Position = UDim2.new(0, (i-1)*86, 0, 0)
...
local function createESP()
    ...
    for _, plr in ipairs(Players:GetPlayers()) do
        if plr ~= player then
            local char = plr.Character            if char and char:FindFirstChild("HumanoidRootPart") then
...
ftText.Text = "$ RTXRRR v8.0 // ULTIMATE EDITION"
...
print("==========================================")
print("✅ RTXRRR v8.0 - FINAL WORKING VERSION")
print("📋 Features:")
...
print("==========================================")
print("✅ Click ⚡ or press Right Control to open!")