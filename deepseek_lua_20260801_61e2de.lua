-- ==================================================
-- REDDIEHUB v25.1 - ULTIMATE PREMIUM EDITION
-- Fixed Loading • All Features Working
-- Floating Teleport • Skybox • Font Changer
...
authTitle.Text = "REDDIEHUB v25.1"
...
activateBtn.MouseButton1Click:Connect(function()
    ...
    if key == "Ali" then
        ...
        notify("🖥️ ReddieHub v25.1 Loaded! Click 🖥️ to open", 4)
...
-- Camlock button with custom image - using ImageLabel instead of ImageButton for compatibility
local camlockBtn = Instance.new("ImageLabel")
...
-- Make it clickable
local camlockClicker = Instance.new("TextButton")
camlockClicker.Size = UDim2.new(1, 0, 1, 0)
camlockClicker.BackgroundTransparency = 1
camlockClicker.Text = ""
camlockClicker.Parent = camlockFrame
...
camlockClicker.MouseButton1Click:Connect(function()
    ...
    pcall(function()
        UserInputService.InputBegan:Connect(function(input, gameProcessed)
            ...
            if input.KeyCode == Enum.KeyCode.Q then
                camlockClicker.MouseButton1Click:Fire()
            end
        end)
    end)
...
ftText.Text = "$ REDDIEHUB v25.1 // KEY: Ali // TERMINAL EDITION"
...
print("==========================================")
print("✅ ReddieHub v25.1 - ULTIMATE PREMIUM EDITION")
print("📋 Features:")
