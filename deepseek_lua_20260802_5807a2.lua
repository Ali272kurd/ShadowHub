-- ==================================================
-- RTXRRR v2.3 - ULTIMATE VISUAL ENHANCER (NO SOUNDS)
-- 90s Terminal Style • Font Changer • Skybox Changer • FPS Boost • Ultra HDR
-- Working Open/Close Button • Animation • Background Image
-- ==================================================

print("Loading RTXRRR v2.3...")
...
-- Open/Close with animation - NO SOUNDS
...
title.Text = "$ RTXRRR v2.3 // VISUAL ENHANCER"
...
ftText.Text = "$ RTXRRR v2.3 // TERMINAL EDITION"
...
print("==========================================")
print("✅ RTXRRR v2.3 - TERMINAL EDITION (NO SOUNDS)")
print("📋 Features:")
