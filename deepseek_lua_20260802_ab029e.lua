-- ==================================================
-- RTXRRR v2.2 - ULTIMATE VISUAL ENHANCER (COMPLETE FIX)
-- 90s Terminal Style • Font Changer • Skybox Changer • FPS Boost • Ultra HDR
-- Working Open/Close Button • Sounds • Animation • Background Image
-- ==================================================

print("Loading RTXRRR v2.2...")
...
local C = {
    ...
    secondaryGlow = Color3.fromRGB(150, 150, 150),
...
-- ==================================================
-- SOUND EFFECTS - Using working sound IDs
-- ==================================================

local function playSound(soundId, volume)
    pcall(function()
        local sound = Instance.new("Sound")
        sound.SoundId = soundId or "rbxassetid://9120405348" -- Working click sound
...
local function playOpenSound()
    playSound("rbxassetid://9120405348", 0.3)
end

local function playCloseSound()
    playSound("rbxassetid://9120405348", 0.2)
end

local function playVrrSound()
    playSound("rbxassetid://9120405348", 0.4)
end

local function playButtonSound()
    playSound("rbxassetid://9120405348", 0.15)
end
...
-- Open/Close with animation and sound - FIXED
toggleBtn.MouseButton1Click:Connect(function()
    ...
    if hub.Visible == false then
        ...
        hub.Position = UDim2.new(0.5, -225, 0.5, -300)
        
        local tween = TweenService:Create(hub, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
        ...
        local tween = TweenService:Create(hub, TweenInfo.new(0.2, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
            Position = UDim2.new(0.5, -225, 0.5, -400),
...
title.Text = "$ RTXRRR v2.2 // VISUAL ENHANCER"
...
-- ==================================================
-- FONT CHANGER - 5 Fonts (Only Texts)
-- ==================================================
...
local p1 = tabPages[1]
section(p1, "FONT CHANGER - 5 FONTS (Texts Only)")
...
ftText.Text = "$ RTXRRR v2.2 // TERMINAL EDITION"
...
print("==========================================")
print("✅ RTXRRR v2.2 - TERMINAL EDITION (COMPLETE FIX)")
print("📋 Features:")
print("   🔤 5 Font Changer (Texts Only)")
...
print("   💻 Dark & White Terminal Style")
print("   🔊 Working Open/Close with Sounds & Animation")
print("   🖼️ Background Image Working")
print("==========================================")
