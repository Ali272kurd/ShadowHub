-- ==================================================
-- RTXRRR v2.1 - ULTIMATE VISUAL ENHANCER (FULLY FIXED)
...
local function playOpenSound()
    pcall(function()
        ...
        sound.SoundId = "rbxassetid://9120392721" -- Click sound
        sound.Volume = 0.3
...
-- Open/Close with animation and sound
toggleBtn.MouseButton1Click:Connect(function()
    ...
    if hub.Visible == false then
        ...
        hub.Position = UDim2.new(0.5, -225, 0.5, -280)
...
pcall(function()
    if bgImage.Image == "" then
        bgImage.Image = "https://create.roblox.com/store/asset/126049593669150/IMG9331"
    end
end)
...
title.Text = "$ RTXRRR v2.1 // VISUAL ENHANCER"
...
ftText.Text = "$ RTXRRR v2.1 // TERMINAL EDITION"
...
print("==========================================")
print("✅ RTXRRR v2.1 - TERMINAL EDITION (FULLY FIXED)")
print("📋 Features:")
