-- ==================================================
-- REDDIEHUB v24.0 - RETRO TERMINAL EDITION
-- 90s Computer Style • Black & White • Sharp Edges
-- Clean HvH Terminal • No Triggerbot
-- ==================================================

-- Safety pcall for all operations
local success, err = pcall(function()

print("Loading ReddieHub v24.0 Retro Terminal...")
...
-- ==================================================
-- AUTH LOADING SCREEN - Retro Terminal
-- ==================================================
...
borderCorner.CornerRadius = UDim.new(0, 0) -- Sharp edges
...
authTitle.Text = "REDDIEHUB v24.0"
...
activateBtn.MouseButton1Click:Connect(function()
    ...
    if key == "DaddyAli-:3" then
        ...
        notify("🖥️ ReddieHub v24.0 Loaded! Click 🖥️ to open", 4)
...
hub.Size = UDim2.new(0, 620, 0, 520)
hub.Position = UDim2.new(0.5, -310, 0.5, -260)
...
hc.CornerRadius = UDim.new(0, 0) -- Sharp edges
hc.Parent = hub
...
-- ==================================================
-- PREMIUM OPEN/CLOSE BUTTON - Retro
-- ==================================================
...
local tabNames = {"🏃 Move", "📍 Tele", "🎯 Lock", "👁️ ESP", "🎮 Tools", "📊 Stats"}
local tabBtns = {}
local tabPages = {}

for i, name in ipairs(tabNames) do
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0, 94, 0, 34)
...
local function colorPicker(parent, text, default, cb)
    -- Simplified for retro - just black/white/green
    local f = Instance.new("Frame")
    f.Size = UDim2.new(1, 0, 0, 34)
    f.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    f.BackgroundTransparency = 0.1
    ...
    colorBtn.Position = UDim2.new(0, 80, 0.5, -12)
    colorBtn.BackgroundColor3 = default
    colorBtn.BorderSizePixel = 1
    colorBtn.BorderColor3 = C.dim
    colorBtn.Text = ""
    colorBtn.Parent = f
    local colorCorner = Instance.new("UICorner")
    colorCorner.CornerRadius = UDim.new(0, 0)
    ...
    colorBtn.MouseButton1Click:Connect(function()
        ...
        menu.Position = UDim2.new(0, 80, 0, 34)
    ...
    pcall(function()
        UserInputService.InputBegan:Connect(function(input, gameProcessed)
            ...
            if input.KeyCode == Enum.KeyCode.RightShift then
                ...
                if hub.Visible then
                    pcall(function()
                        hub:TweenSize(UDim2.new(0, 620, 0, 500), "Out", "Back", 0.5, true)
                    end)
                    toggleBtn.Text = "🖥️"
...
-- Move Forward button with hold functionality
...
ftText.Text = "$ REDDIEHUB v24.0 // TERMINAL EDITION"
...
print("==========================================")
print("✅ ReddieHub v24.0 - RETRO TERMINAL EDITION")
print("📋 Features:")
