-- ==================================================
-- RTXRRR v2.4 - ULTIMATE VISUAL ENHANCER (FULLY WORKING)
-- 90s Terminal Style • Font Changer • Skybox Changer • FPS Boost • Ultra HDR
-- Fixed Button States • Working Tabs • Background Image
-- ==================================================

print("Loading RTXRRR v2.4...")
...
-- Fix: Reset button state properly
local function resetToggleButton()
    toggleBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    toggleBtn.BackgroundTransparency = 0.3
    toggleBtn.TextColor3 = C.primary
    toggleBtn.BorderColor3 = C.primary
...
local function setToggleButtonActive()
...
-- BACKGROUND IMAGE - Using the correct asset
...
title.Text = "$ RTXRRR v2.4 // VISUAL ENHANCER"
...
-- ==================================================
-- UI HELPERS - ALL BUTTONS AND TOGGLES
-- ==================================================
...
ftText.Text = "$ RTXRRR v2.4 // TERMINAL EDITION"
...
print("==========================================")
print("✅ RTXRRR v2.4 - FULLY WORKING")
print("📋 Features:")
