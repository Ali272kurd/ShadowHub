-- ==================================================
-- REDDIEHUB v24.1 - RETRO TERMINAL EDITION
-- 90s Computer Style • Black & White • Sharp Edges
-- Clean HvH Terminal • Floating Movement • Skybox • Font Changer
-- ==================================================

-- Safety pcall for all operations
local success, err = pcall(function()

print("Loading ReddieHub v24.1 Retro Terminal...")
...
-- ==================================================
-- RETRO TERMINAL COLORS - Black & White
-- ==================================================
...
local C = {
    ...
    secondary = Color3.fromRGB(0, 200, 255),       -- Cyan (accents)
    ...
    panelLight = Color3.fromRGB(14, 14, 14),
...
-- ==================================================
-- RETRO STROKE HELPER - Sharp edges
-- ==================================================

local function addRetroStroke(obj, thickness)
...
borderFrame.BorderColor3 = C.primary
borderFrame.ClipsDescendants = true
borderFrame.Parent = loadingBg

local borderCorner = Instance.new("UICorner")
borderCorner.CornerRadius = UDim.new(0, 0)
borderCorner.Parent = borderFrame

addRetroStroke(borderFrame, 2)
...
authTitle.Text = "REDDIEHUB v24.1"
authTitle.TextColor3 = C.primary
...
usernameLabel.TextColor3 = C.primary
...
activateBtn.MouseButton1Click:Connect(function()
    ...
    if key == "Ali" then
        ...
        notify("🖥️ ReddieHub v24.1 Loaded! Click 🖥️ to open", 4)
...
-- ==================================================
-- MAIN HUB - Retro Terminal
-- ==================================================

local hub = Instance.new("Frame")
hub.Size = UDim2.new(0, 650, 0, 580)
hub.Position = UDim2.new(0.5, -325, 0.5, -290)
hub.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
hub.BackgroundTransparency = 0.05
hub.BorderSizePixel = 1
...
addRetroStroke(hub, 2)

-- Tab Background - Wavey Crystals and Snowflakes
local tabBackground = Instance.new("ImageLabel")
tabBackground.Size = UDim2.new(1, 0, 1, -50)
tabBackground.Position = UDim2.new(0, 0, 0, 50)
tabBackground.BackgroundTransparency = 1
tabBackground.Image = "rbxassetid://136513869855798" -- Crystal wave background
tabBackground.ScaleType = Enum.ScaleType.Crop
tabBackground.Visible = true
tabBackground.Parent = hub
...
tabC.Position = UDim2.new(0, 10, 0, 52)
...
content.BorderColor3 = C.primary
...
addRetroStroke(content, 1.5)

-- Make content background transparent to show tab background
content.BackgroundTransparency = 0.3

local tabNames = {"🏃 Move", "📍 Tele", "🎯 Lock", "👁️ ESP", "🎮 Tools", "📊 Stats", "🌌 Sky", "🔤 Font"}
local tabBtns = {}
local tabPages = {}
...
for i, name in ipairs(tabNames) do
    ...
    btn.Position = UDim2.new(0, (i-1)*81, 0, 0)
...
ttl.Text = "REDDIEHUB v24.1"
ttl.TextColor3 = C.primary
ttl.TextSize = 18
...
closeB.Position = UDim2.new(1, -42, 0.5, -18)
...
-- ==================================================
-- UI HELPERS - Retro Terminal Style
-- ==================================================
...
local function inputBox(parent, placeholder)
    ...
    i.PlaceholderColor3 = Color3.fromRGB(60, 60, 60)
    i.Text = ""
    i.TextColor3 = C.text
    i.TextSize = 12
...
local function slider(parent, text, min, max, def, cb)
    ...
    valueInput.Size = UDim2.new(0, 48, 0, 22)
    valueInput.Position = UDim2.new(1, -56, 0, 0)
...
local showForwardSteps = true
local showBackwardSteps = true
local floatingEnabled = false
local forwardStepCount = 10
local backwardStepCount = 10

-- ==================================================
-- FLOATING BUTTONS
-- ==================================================

local forwardFloatBtn = nil
local backwardFloatBtn = nil
...
local function createFloatingButtons()
    ...
    floatContainer.Size = UDim2.new(0, 140, 0, 80)
    floatContainer.Position = UDim2.new(0.5, -70, 0.7, 0)
    floatContainer.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    floatContainer.BackgroundTransparency = 0.2
    floatContainer.BorderSizePixel = 2
    floatContainer.BorderColor3 = C.primary
    floatContainer.ClipsDescendants = true
    floatContainer.Visible = false
    floatContainer.Parent = screenGui
    
    local floatCorner = Instance.new("UICorner")
    floatCorner.CornerRadius = UDim.new(0, 0)
    floatCorner.Parent = floatContainer
    addRetroStroke(floatContainer, 2)
    
    -- Forward button
    forwardFloatBtn = Instance.new("TextButton")
    forwardFloatBtn.Size = UDim2.new(0, 120, 0, 30)
    forwardFloatBtn.Position = UDim2.new(0.5, -60, 0, 6)
    forwardFloatBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    forwardFloatBtn.BackgroundTransparency = 0.2
    forwardFloatBtn.BorderSizePixel = 2
    forwardFloatBtn.BorderColor3 = C.primary
    forwardFloatBtn.Text = "→ FORWARD: " .. forwardStepCount
    forwardFloatBtn.TextColor3 = C.primary
    forwardFloatBtn.TextSize = 11
    forwardFloatBtn.Font = Enum.Font.Code
    forwardFloatBtn.Parent = floatContainer
    
    local fCorner = Instance.new("UICorner")
    fCorner.CornerRadius = UDim.new(0, 0)
    fCorner.Parent = forwardFloatBtn
    
    forwardFloatBtn.MouseButton1Click:Connect(function()
        teleportForward(forwardStepCount)
        notify("🚀 Teleported " .. forwardStepCount .. " steps forward!", 2)
    end)
    
    -- Backward button
    backwardFloatBtn = Instance.new("TextButton")
    backwardFloatBtn.Size = UDim2.new(0, 120, 0, 30)
    backwardFloatBtn.Position = UDim2.new(0.5, -60, 0, 42)
    backwardFloatBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    backwardFloatBtn.BackgroundTransparency = 0.2
    backwardFloatBtn.BorderSizePixel = 2
    backwardFloatBtn.BorderColor3 = C.primary
    backwardFloatBtn.Text = "← BACKWARD: " .. backwardStepCount
    backwardFloatBtn.TextColor3 = C.primary
    backwardFloatBtn.TextSize = 11
    backwardFloatBtn.Font = Enum.Font.Code
    backwardFloatBtn.Parent = floatContainer
    
    local bCorner = Instance.new("UICorner")
    bCorner.CornerRadius = UDim.new(0, 0)
    bCorner.Parent = backwardFloatBtn
    
    backwardFloatBtn.MouseButton1Click:Connect(function()
        pcall(function()
            ...
            local newPos = root.Position - lookVector * backwardStepCount
            ...
            notify("🔙 Teleported " .. backwardStepCount .. " steps backward!", 2)
        end)
    end)
    ...
    pcall(function()
        floatContainer.InputBegan:Connect(function(i)
            if i.UserInputType == Enum.UserInputType.MouseButton1 then
                floatDragging = true
                floatDragOff = Vector2.new(mouse.X - floatContainer.AbsolutePosition.X, mouse.Y - floatContainer.AbsolutePosition.Y)
            end
        end)
    end)
    ...
    pcall(function()
        UserInputService.InputChanged:Connect(function(i)
            if floatDragging and i.UserInputType == Enum.UserInputType.MouseMovement then
                pcall(function()
                    floatContainer.Position = UDim2.new(0, mouse.X - floatDragOff.X, 0, mouse.Y - floatDragOff.Y)
                end)
            end
        end)
    end)
...
local function toggleFly()
    ...
    if flying then
        -- Create velocity and gyro for flight
        ...
        notify("✈️ Flight ENABLED! Use WASD to fly", 2)
        ...
        notify("✈️ Flight DISABLED", 2)
    end
end

-- ==================================================
-- SMART TELEPORT (Original)
-- ==================================================
...
camlockBtn.Font = Enum.Font.Code
...
statusDot.BorderColor3 = C.dim
statusDot.Parent = camlockFrame
local statusDotCorner = Instance.new("UICorner")
statusDotCorner.CornerRadius = UDim.new(0, 0)
...
camlockPopupGlass.BackgroundTransparency = 0.94
...
camlockPopupGlassCorner.CornerRadius = UDim.new(0, 0)
...
popupAvatarCorner.CornerRadius = UDim.new(0, 0)
...
popupHealthBarBg.BackgroundColor3 = Color3.fromRGB(10, 10, 10)
popupHealthBarBg.BorderSizePixel = 1
popupHealthBarBg.BorderColor3 = C.dim
popupHealthBarBg.Parent = camlockPopup
local popupHealthBarBgCorner = Instance.new("UICorner")
popupHealthBarBgCorner.CornerRadius = UDim.new(0, 0)
...
popupHealthFillCorner.CornerRadius = UDim.new(0, 0)
...
popupHealthText.Font = Enum.Font.Code
...
popupDistText.Font = Enum.Font.Code
...
offsetLabel.TextColor3 = C.primary
...
local visualsSaturation = 1
local visualsBloom = 0.5
local visualsColorTemp = 0
local visualsExposure = 0.5
...
function setupKeybinds()
    pcall(function()
        UserInputService.InputBegan:Connect(function(input, gameProcessed)
            ...
            if input.KeyCode == Enum.KeyCode.RightShift then
                ...
                if hub.Visible then
                    pcall(function()
                        hub:TweenSize(UDim2.new(0, 650, 0, 580), "Out", "Back", 0.5, true)
                    end)
                    toggleBtn.Text = "🖥️"
    ...
    print("✅ PC Keybinds: RightShift=Open, Q=Camlock, F=Flight")
end
...
section(p1, "MOVEMENT ENGINE")

-- Show Forward Steps Toggle
local showForwardToggle = toggle(p1, "Show Forward Step Button", true, function(s)
    showForwardSteps = s
    if floatContainer then
        forwardFloatBtn.Visible = s
    end
end)

-- Show Backward Steps Toggle
local showBackwardToggle = toggle(p1, "Show Backward Step Button", true, function(s)
    showBackwardSteps = s
    if floatContainer then
        backwardFloatBtn.Visible = s
    end
end)

-- Floating Mode Toggle
local floatingToggle = toggle(p1, "Floating Mode (Fly)", false, function(s)
    floatingEnabled = s
    if floatContainer then
        floatContainer.Visible = s
    end
    if s then
        toggleFly()
    else
...
-- Forward Steps Slider
local forwardSlider = slider(p1, "Forward Steps", 1, 100, 10, function(v)
    forwardStepCount = math.floor(v)
    if forwardFloatBtn then
        forwardFloatBtn.Text = "→ FORWARD: " .. forwardStepCount
    end
end)

-- Backward Steps Slider
local backwardSlider = slider(p1, "Backward Steps", 1, 100, 10, function(v)
    backwardStepCount = math.floor(v)
    if backwardFloatBtn then
        backwardFloatBtn.Text = "← BACKWARD: " .. backwardStepCount
    endend)

section(p1, "CHOSEN POSITION")

-- Choose button
local chooseBtn = button(p1, "[ CHOOSE POSITION ]", function()
    pcall(function()
        local char = player.Character
        if char then
            local root = char:FindFirstChild("HumanoidRootPart")
            if root then
                ...
                chooseBtn.BorderColor3 = C.green
...
-- Unchoose button
local unchooseBtn = button(p1, "[ ✗ UNCHOOSE ]", function()
    chosenPosition = nil
    isChosen = false
    chooseBtn.Text = "[ CHOOSE POSITION ]"
    chooseBtn.BorderColor3 = C.primary
    chooseBtn.TextColor3 = C.primary
    notify("🔄 Position unchosen!", 2)
end, C.red)

-- Teleport to chosen
local tpChosenBtn = button(p1, "[ TELEPORT TO CHOSEN ]", function()
    teleportToChosen()
end)
...
-- Mooze Mob inject
section(p1, "MOOZE MOB")
label(p1, "Click to inject Mooze Mob script", C.gold)
...
local viewBtn = button(p2, "[ VIEW ]", function()
...
comboFrame.BorderSizePixel = 1
comboFrame.BorderColor3 = C.dim
...
comboInput.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
comboInput.Text = "8"
comboInput.TextColor3 = C.text
comboInput.TextSize = 12
comboInput.Font = Enum.Font.Code
comboInput.TextXAlignment = Enum.TextXAlignment.Center
comboInput.BorderSizePixel = 1
comboInput.BorderColor3 = C.dim
comboInput.Parent = comboFrame
local comboInputCorner = Instance.new("UICorner")
comboInputCorner.CornerRadius = UDim.new(0, 0)
...
bpFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
bpFrame.BackgroundTransparency = 0.1
bpFrame.BorderSizePixel = 1
bpFrame.BorderColor3 = C.dim
bpFrame.Parent = p3
local bpCorner = Instance.new("UICorner")
bpCorner.CornerRadius = UDim.new(0, 0)
bpCorner.Parent = bpFrame
addRetroStroke(bpFrame, 1.2)
...
bpBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
bpBtn.BorderSizePixel = 1
bpBtn.BorderColor3 = C.dim
bpBtn.Text = camlockBodyPart .. " ▼"
bpBtn.TextColor3 = C.text
bpBtn.TextSize = 10
bpBtn.Font = Enum.Font.Code
bpBtn.Parent = bpFrame
local bpBtnCorner = Instance.new("UICorner")
bpBtnCorner.CornerRadius = UDim.new(0, 0)
bpBtnCorner.Parent = bpBtn
addRetroStroke(bpBtn, 1)
...
bpBtn.MouseButton1Click:Connect(function()
    ...
    bpMenu.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    bpMenu.BorderSizePixel = 1
    bpMenu.BorderColor3 = C.primary
    bpMenu.ClipsDescendants = true
    bpMenu.Parent = bpFrame
    local menuCorner = Instance.new("UICorner")
    menuCorner.CornerRadius = UDim.new(0, 0)
    menuCorner.Parent = bpMenu
    addRetroStroke(bpMenu, 1)
    ...
    for _, part in ipairs(bodyParts) do
        ...
        partBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
        partBtn.BorderSizePixel = 1
        partBtn.BorderColor3 = C.dim
        partBtn.Text = part
        partBtn.TextColor3 = C.text
        partBtn.TextSize = 9
        partBtn.Font = Enum.Font.Code
...
local function createPremiumESP(char, plr)
    ...
    healthBg.BackgroundColor3 = Color3.fromRGB(5, 5, 5)
    healthBg.BackgroundTransparency = 0.2
    healthBg.BorderSizePixel = 1
    healthBg.BorderColor3 = C.dim
    healthBg.Parent = healthBar
    local healthBgCorner = Instance.new("UICorner")
    healthBgCorner.CornerRadius = UDim.new(0, 0)
    ...
    distText.Text = "0m"
    distText.TextColor3 = Color3.fromRGB(100, 100, 100)
    distText.TextSize = 6
...
section(p5, "MACRO")
button(p5, "[ EXECUTE MACRO ]", function()
    pcall(function()
...
local p6 = tabPages[6]
section(p6, "PERFORMANCE")
local fpsL = label(p6, "FPS: 0", C.gold)
local pingL = label(p6, "Ping: 0 ms", C.gold)
local memL = label(p6, "Memory: 0 MB", C.gold)
...
-- ==================================================
-- TAB 7: SKYBOX CHANGER
-- ==================================================

local p7 = tabPages[7]
section(p7, "SKYBOX CHANGER")
...
for _, data in ipairs(skyboxButtons) do
    button(p7, "[ " .. data[1] .. " ]", function()
        changeSkybox(data[2])
    end, C.primary)
end

button(p7, "[ RESET SKYBOX ]", function()
    pcall(function()
        local sky = Lighting:FindFirstChild("Sky")
        if sky then
            sky:Destroy()
...
local p8 = tabPages[8]
section(p8, "FONT CHANGER")

local fonts = {
    {"Minecraft", Enum.Font.SourceSans},
    {"Gotham", Enum.Font.Gotham},
    {"Gotham Bold", Enum.Font.GothamBold},
    {"Gotham Semibold", Enum.Font.GothamSemibold},
...
local function changeFont(font)
    pcall(function()
        -- Change font for all TextLabels in the game
        ...
        notify("🔤 Font changed!", 2)
    end)
end

for _, fontData in ipairs(fonts) do
    button(p8, "[ " .. fontData[1] .. " ]", function()
        changeFont(fontData[2])
    end, C.primary)
end

button(p8, "[ RESET FONT ]", function()
    pcall(function()
        for _, obj in ipairs(game:GetDescendants()) do
            if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then
                pcall(function()
...
addRetroStroke(toggleBtn, 2)

-- FIX: Toggle button click event
...
-- ==================================================
-- LOADING SCREEN DESTROY - FIXED
-- ==================================================

-- Force destroy loading screen after 7 seconds if not already destroyed
task.spawn(function()
    task.wait(7)
    pcall(function()
        if loadingScreenGui and loadingScreenGui.Parent then
            loadingScreenGui:Destroy()
            print("✅ Loading screen force destroyed!")
        end
    end)
end)
...
print("==========================================")
print("✅ ReddieHub v24.1 - RETRO TERMINAL EDITION")
print("📋 Features:")
print("   🖥️ 90s Computer Terminal Style")
...
print("   🔤 Font Changer")
print("   🚀 Floating Movement Buttons")
print("   ✈️ Flight Mode")
print("   ⌨️ PC Keybinds: RightShift=Open, Q=Camlock, F=Flight")
print("   💎 Clean Retro HvH Style")
print("==========================================")
