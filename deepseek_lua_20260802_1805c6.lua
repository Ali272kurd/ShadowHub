...
toggleBtn.Size = isMobile and UDim2.new(0, 70, 0, 70) or UDim2.new(0, 55, 0, 55)
toggleBtn.Position = UDim2.new(1, -(isMobile and 80 or 65), 0, 10)
toggleBtn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
toggleBtn.BackgroundTransparency = 0.2
toggleBtn.Text = "⚡"
toggleBtn.TextColor3 = C.primary
toggleBtn.TextSize = isMobile and 32 or 28
...
hub.Size = isMobile and UDim2.new(0, 480, 0, 540) or UDim2.new(0, 420, 0, 460)
hub.Position = UDim2.new(0.5, -(isMobile and 240 or 210), 0.5, -(isMobile and 270 or 230))
...
header.Size = UDim2.new(1, 0, 0, isMobile and 48 or 38)
...
title.Size = UDim2.new(1, -20, 0, isMobile and 26 or 20)
title.Position = UDim2.new(0, 10, 0, isMobile and 4 or 3)
title.BackgroundTransparency = 1
title.Text = "$ RTXRRR v7.0"
...
subTitle.Size = UDim2.new(1, -20, 0, isMobile and 14 or 10)
subTitle.Position = UDim2.new(0, 10, 0, isMobile and 32 or 25)
subTitle.BackgroundTransparency = 1
subTitle.Text = "> FONTS • SKYBOX • FPS • HDR • ESP"
subTitle.TextColor3 = C.dim
subTitle.TextSize = isMobile and 10 or 8
...
closeB.Size = UDim2.new(0, isMobile and 32 or 24, 0, isMobile and 32 or 24)
closeB.Position = UDim2.new(1, -(isMobile and 40 or 32), 0.5, -(isMobile and 16 or 12))
closeB.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
closeB.BackgroundTransparency = 0.3
closeB.Text = "X"
closeB.TextColor3 = C.primary
closeB.TextSize = isMobile and 14 or 11
...
tabContainer.Size = UDim2.new(1, -20, 0, isMobile and 30 or 24)
tabContainer.Position = UDim2.new(0, 10, 0, isMobile and 52 or 42)
tabContainer.BackgroundTransparency = 1
tabContainer.BorderSizePixel = 0
tabContainer.Parent = hub

local content = Instance.new("Frame")
content.Size = UDim2.new(1, -20, 1, -(isMobile and 98 or 80))
content.Position = UDim2.new(0, 10, 0, isMobile and 86 or 70)
...
for i, name in ipairs(tabNames) do
    ...
    btn.Size = UDim2.new(0, isMobile and 80 or 72, 0, isMobile and 26 or 20)
    btn.Position = UDim2.new(0, (i-1) * (isMobile and 84 or 76), 0, 0)
...
-- ==================================================
-- UI HELPERS - SIMPLIFIED FOR MOBILE
-- ==================================================

local function section(parent, text)
    local s = Instance.new("Frame")
    s.Size = UDim2.new(1, 0, 0, isMobile and 22 or 18)
...
local function label(parent, text, color)
    local l = Instance.new("TextLabel")
    l.Size = UDim2.new(1, 0, 0, isMobile and 16 or 12)
    l.BackgroundTransparency = 1
    l.Text = text
...
local function terminalButton(parent, text, cb, color)
    ...
    b.Size = UDim2.new(1, 0, 0, isMobile and 28 or 22)
    b.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    ...
    b.Text = text
    b.TextColor3 = color
    b.TextSize = isMobile and 9 or 8
...
local function terminalToggle(parent, text, default, cb)
    ...
    f.Size = UDim2.new(1, 0, 0, isMobile and 28 or 22)
    ...
    local btn = Instance.new("TextButton")
    btn.Size = UDim2.new(0, isMobile and 38 or 32, 0, isMobile and 20 or 16)
    btn.Position = UDim2.new(1, -(isMobile and 44 or 38), 0.5, -(isMobile and 10 or 8))
    ...
    btn.TextSize = isMobile and 8 or 7
    btn.Font = Enum.Font.Code
    btn.Parent = f
...
local function terminalSlider(parent, text, min, max, def, suffix, cb)
    ...
    local l = Instance.new("TextLabel")
    l.Size = UDim2.new(1, -16, 0, isMobile and 14 or 12)
    ...
    bg.Size = UDim2.new(1, -16, 0, 3)
    bg.Position = UDim2.new(0, 8, 0, isMobile and 20 or 16)
    ...
    valueInput.Size = UDim2.new(0, isMobile and 36 or 30, 0, isMobile and 16 or 12)
    valueInput.Position = UDim2.new(1, -(isMobile and 42 or 36), 0, 0)
    valueInput.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    valueInput.Text = tostring(def)
    valueInput.TextColor3 = C.text
    valueInput.TextSize = isMobile and 9 or 8
...
local function terminalColorPicker(parent, text, default, cb)
    ...
    colorBtn.Size = UDim2.new(0, isMobile and 28 or 22, 0, isMobile and 20 or 16)
    colorBtn.Position = UDim2.new(0, 68, 0.5, -(isMobile and 10 or 8))
    ...
    colorBtn.MouseButton1Click:Connect(function()
        ...
        menu.Position = UDim2.new(0, 68, 0, 26)
...
local skyboxList = {
    {"Cartoon", "rbxassetid://136513869855798"},
    {"Red", "rbxassetid://136055162054954"},
    {"Space", "rbxassetid://230057424"},
    {"Rainbow", "rbxassetid://1848671824"},
    {"Sunset", "rbxassetid://5671234785"},
    {"Moon", "rbxassetid://9876543210"},
    {"Starry", "rbxassetid://4567891230"},
    {"Cloudy", "rbxassetid://7891234560"},
    {"Anime", "rbxassetid://3216549870"},
    {"Cherry", "rbxassetid://6549873210"},
}
...
crosshairInput.Size = UDim2.new(1, -10, 0, isMobile and 28 or 22)
...
crosshairInput.TextSize = isMobile and 9 or 8
crosshairInput.Font = Enum.Font.Code
crosshairInput.PlaceholderText = "ID..."
...
footer.Size = UDim2.new(1, -8, 0, isMobile and 18 or 16)
footer.Position = UDim2.new(0, 4, 1, -(isMobile and 22 or 18))
...
ftText.Text = "$ RTXRRR v7.0 // MOBILE"
ftText.TextColor3 = C.dim
ftText.TextSize = isMobile and 9 or 8
...
print("==========================================")
print("✅ RTXRRR v7.0 - MOBILE EDITION (FIXED)")
print("📋 Features:")
